			...
			this.addKeyListener(new KeyAdapter(){
				public void keyPressed(KeyEvent e){
					...
					case KeyEvent.VK_RIGHT:
						avata.setLocation(avata.getX()+10, avata.getY());
						break;
					/*case KeyEvent.VK_K: monsterThread1.interrupt(); break;
					case KeyEvent.VK_J: monsterThread2.interrupt(); break;
					case KeyEvent.VK_L: monsterThread3.interrupt(); break;*/
					case KeyEvent.VK_K: monster1.setFlag(); break;
					case KeyEvent.VK_J: monster2.setFlag(); break;
					case KeyEvent.VK_L: monster3.setFlag(); break;
					}
				}
			});
		}
